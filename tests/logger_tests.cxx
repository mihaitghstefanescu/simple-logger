...
class logger_unit : public ::testing::Test
{
  protected:
    ...
    logger_unit()
    {
        SIMPLE_LOGGER::outputFile() = LOG_FILE;
    }
...
{
    // By default, SIMPLE_LOGGER logs with DEBUG level.
    SIMPLE_LOGGER::LogLevel() = LOG_ERROR;
    ASSERT_STREQ(SIMPLE_LOGGER::getLogLevelName(SIMPLE_LOGGER::LogLevel()).c_str(), "ERROR");
    SIMPLE_LOGGER::LogLevel() = LOG_DEBUG;
    ASSERT_STREQ(SIMPLE_LOGGER::getLogLevelName(SIMPLE_LOGGER::LogLevel()).c_str(), "DEBUG");
